import {c as et, a as tt, b as me, o as nt, u as rt} from "./index-CFEOR5vx.js";
...
const {toString: st} = Object.prototype, {getPrototypeOf: ce} = Object, W = (e => t => {
        const n = st.call(t);
        return e[n] || (e[n] = n.slice(8, -1).toLowerCase())
    })(Object.create(null)), C = e => (e = e.toLowerCase(), t => W(t) === e),
    $ = e => t => typeof t === e, {isArray: U} = Array, q = $("undefined");
...
const at = $("string"), x = $("function"), Le = $("number"), K = e => e !== null && typeof e == "object",
    ct = e => e === !0 || e === !1, z = e => {
        if (W(e) !== "object") return !1;
        const t = ce(e);
        return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e)
    }, ut = C("Date"), lt = C("File"), ft = C("Blob"), dt = C("FileList"), pt = e => K(e) && x(e.pipe), ht = e => {
        let t;
        return e && (typeof FormData == "function" && e instanceof FormData || x(e.append) && ((t = W(e)) === "formdata" || t === "object" && x(e.toString) && e.toString() === "[object FormData]"))
    }, mt = C("URLSearchParams"), [yt, bt, wt, Et] = ["ReadableStream", "Request", "Response", "Headers"].map(C),
    Rt = e => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");

function H(e, t, {allOwnKeys: n = !1} = {}) {
    if (e === null || typeof e > "u") return;
    let r, s;
    if (typeof e != "object" && (e = [e]), U(e)) for (r = 0, s = e.length; r < s; r++) t.call(null, e[r], r, e); else {
...
const St = (e, t, n, {allOwnKeys: r} = {}) => (H(t, (s, o) => {
    ...
    }, {allOwnKeys: r}), e), gt = e => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e), Ot = (e, t, n, r) => {
        ...
        for (; t-- > 0;) n[t] = e[t];
        return n
    }, Ct = (e => t => e && t instanceof e)(typeof Uint8Array < "u" && ce(Uint8Array)), Nt = (e, t) => {
        ...
        return r
    }, _t = C("HTMLFormElement"), Ft = e => e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function (n, r, s) {
        return r.toUpperCase() + s
    }), ye = (({hasOwnProperty: e}) => (t, n) => e.call(t, n))(Object.prototype), Lt = C("RegExp"), Ue = (e, t) => {
    ...
    }, kt = (e, t) => e != null && Number.isFinite(e = +e) ? e : t, Q = "abcdefghijklmnopqrstuvwxyz", be = "0123456789",
    ke = {DIGIT: be, ALPHA: Q, ALPHA_DIGIT: Q + Q.toUpperCase() + be}, jt = (e = 16, t = ke.ALPHA_DIGIT) => {
        let n = "";
        const {length: r} = t;
...
const Ht = e => {
        ...
        return n(e, 0)
    }, It = C("AsyncFunction"), Mt = e => e && (K(e) || x(e)) && x(e.then) && x(e.catch),
    je = ((e, t) => e ? setImmediate : t ? ((n, r) => (L.addEventListener("message", ({source: s, data: o}) => {
        s === L && o === n && r.length && r.shift()()
    }, !1), s => {
        r.push(s), L.postMessage(n, "*")
    }))(`axios@${Math.random()}`, []) : n => setTimeout(n))(typeof setImmediate == "function", x(L.postMessage)),
...
function G(e, t, n) {
    ...
    t = t || new FormData, n = a.toFlatObject(n, {metaTokens: !0, dots: !1, indexes: !1}, !1, function (y, h) {
    ...
    function l(p, y, h) {
        ...
        if (p && !h && typeof p == "object") {
            if (a.endsWith(y, "{}")) y = r ? y : y.slice(0, -2), p = JSON.stringify(p); else if (a.isArray(p) && Vt(p) || (a.isFileList(p) || a.endsWith(y, "[]")) && (w = a.toArray(p))) return y = Ie(y), w.forEach(function (g, N) {
                !(a.isUndefined(g) || g === null) && t.append(i === !0 ? we([y], N, o) : i === null ? y : y + "[]", u(g))
            }), !1
        }
        return ne(p) ? !0 : (t.append(we(h, y, o), u(p)), !1)
    }

    const d = [], b = Object.assign(vt, {defaultVisitor: l, convertValue: u, isVisitable: ne});
...
const Je = {silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1},
    $t = typeof URLSearchParams < "u" ? URLSearchParams : ue, Kt = typeof FormData < "u" ? FormData : null,
    Gt = typeof Blob < "u" ? Blob : null, Xt = {
        isBrowser: !0,
        classes: {URLSearchParams: $t, FormData: Kt, Blob: Gt},
        protocols: ["http", "https", "file", "blob", "url", "data"]
    }, le = typeof window < "u" && typeof document < "u", re = typeof navigator == "object" && navigator || void 0,
    Qt = le && (!re || ["ReactNative", "NativeScript", "NS"].indexOf(re.product) < 0),
    Zt = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function",
    Yt = le && window.location.href || "http://localhost", en = Object.freeze(Object.defineProperty({
        __proto__: null,
        hasBrowserEnv: le,
        ...
        navigator: re,
        origin: Yt
    }, Symbol.toStringTag, {value: "Module"})), T = {...en, ...Xt};
...
const I = {
    ...
    transformRequest: [function (t, n) {
        ...
        let c;
        if (o) {
            if (r.indexOf("application/x-www-form-urlencoded") > -1) return tn(t, this.formSerializer).toString();
...
const on = a.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
    an = e => {
        const t = {};
        let n, r, s;
        return e && e.split(`
...
class A {
    ...
    set(t, n, r) {
        ...
        if (a.isPlainObject(t) || t instanceof this.constructor) i(t, n); else if (a.isString(t) && (t = t.trim()) && !un(t)) i(an(t), n); else if (a.isHeaders(t)) for (const [c, f] of t.entries()) o(f, c, r); else t != null && o(n, t, r);
        return this
    }
...
`)
    ...
    static accessor(t) {
        const r = (this[Se] = this[Se] = {accessors: {}}).accessors, s = this.prototype;
...
}, Oe = e => (...t) => a.asap(() => e(...t)), mn = T.hasStandardBrowserEnv ? function () {
...
const Ke = e => {
        ...
        t.headers = i = A.from(i), t.url = ze($e(t.baseURL, t.url), e.params, e.paramsSerializer), c && i.set("Authorization", "Basic " + btoa((c.username || "") + ":" + (c.password ? unescape(encodeURIComponent(c.password)) : "")));
        let f;
        if (a.isFormData(n)) {
            if (T.hasStandardBrowserEnv || T.hasStandardBrowserWebWorkerEnv) i.setContentType(void 0); else if ((f = i.getContentType()) !== !1) {
        ...
        return new Promise(function (n, r) {
            ...
            function w() {
                if (!h) return;
                const g = A.from("getAllResponseHeaders" in h && h.getAllResponseHeaders()), O = {
            ...
            "onloadend" in h ? h.onloadend = w : h.onreadystatechange = function () {
                ...
                s.timeoutErrorMessage && (N = s.timeoutErrorMessage), r(new m(N, O.clarifyTimeoutError ? m.ETIMEDOUT : m.ECONNABORTED, e, h)), h = null
        ...
        for await(const n of Tn(e)) yield* gn(n, t)
    }, Tn = async function* (e) {
    ...
    An = X && (typeof TextEncoder == "function" ? (e => t => e.encode(t))(new TextEncoder) : async e => new Uint8Array(await new Response(e).arrayBuffer())),
    Xe = (e, ...t) => {
        try {
            return !!e(...t)
        } catch {
        ...
        return e && !t
    }), xe = 64 * 1024, se = Ge && Xe(() => a.isReadableStream(new Response("").body)), v = {stream: se && (e => e.body)};
X && (e => {
...
const Cn = async e => {
    ...
    if (a.isSpecCompliantForm(e)) return (await new Request(T.origin, {
        method: "POST",
        body: e
    }).arrayBuffer()).byteLength;
    if (a.isArrayBufferView(e) || a.isArrayBuffer(e)) return e.byteLength;
    if (a.isURLSearchParams(e) && (e = e + ""), a.isString(e)) return (await An(e)).byteLength
}, Nn = async (e, t) => {
    ...
    let R = Sn([s, o && o.toAbortSignal()], i), p;
    const y = R && R.unsubscribe && (() => {
        R.unsubscribe()
    });
    let h;
    try {
        if (f && xn && n !== "get" && n !== "head" && (h = await Nn(l, r)) !== 0) {
            let O = new Request(t, {method: "POST", body: r, duplex: "half"}), P;
            if (a.isFormData(r) && (P = O.headers.get("content-type")) && l.setContentType(P), O.body) {
                const [F, M] = ge(h, V(Oe(f)));
                r = Ae(O.body, xe, F, M)
            }
        }
        ...
        if (se && (c || g && y)) {
            ...
            const P = a.toFiniteNumber(S.headers.get("content-length")), [F, M] = c && ge(P, V(Oe(c), !0)) || [];
            S = new Response(Ae(S.body, xe, F, () => {
                M && M(), y && y()
            }), O)
        }
        u = u || "text";
        let N = await v[a.findKey(v, u) || "text"](S, e);
        return !g && y && y(), await new Promise((O, P) => {
            We(O, P, {
                data: N,
...
const Ce = e => `- ${e}`, _n = e => a.isFunction(e) || e === null || e === !1, Qe = {
    getAdapter: e => {
        e = a.isArray(e) ? e : [e];
        const {length: t} = e;
        let n, r;
        ...
        for (let o = 0; o < t; o++) {
            n = e[o];
            let i;
            if (r = n, !_n(n) && (r = oe[(i = String(n)).toLowerCase()], r === void 0)) throw new m(`Unknown adapter '${i}'`);
            if (r) break;
            s[i || "#" + o] = r
        }
        if (!r) {
...
function Ne(e) {
    return ee(e), e.headers = A.from(e.headers), e.data = Y.call(e, e.transformRequest), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), Qe.getAdapter(e.adapter || I.adapter)(e).then(function (r) {
        return ee(e), r.data = Y.call(e, e.transformResponse, r), r.headers = A.from(r.headers), r
    }, function (r) {
        return ve(r) || (ee(e), r && r.response && (r.response.data = Y.call(e, e.transformResponse, r.response), r.response.headers = A.from(r.response.headers))), Promise.reject(r)
    })
}
...
fe.transitional = function (t, n, r) {
    ...
    return (o, i, c) => {
        ...
        return n && !Pe[i] && (Pe[i] = !0, console.warn(s(i, " has been deprecated since v" + n + " and will be removed in the near future"))), t ? t(o, i, c) : !0
    }
};
...
const ie = {assertOptions: Fn, validators: fe}, _ = ie.validators;

class B {
    constructor(t) {
        this.defaults = t, this.interceptors = {request: new Re, response: new Re}
    }
...
` + o) : r.stack = o
    ...
    _request(t, n) {
        ...
        }, !1), s != null && (a.isFunction(s) ? n.paramsSerializer = {serialize: s} : ie.assertOptions(s, {
            encode: _.function,
...
function Ye(e) {
    const t = new B(e), n = _e(B.prototype.request, t);
...
E.HttpStatusCode = ae;
E.default = E;
const pe = E.create({baseURL: "/api", timeout: 5e3});
pe.interceptors.request.use(e => (e.headers.token = "test token", e.headers["Content-Type"] = "application/json;charset=utf-8", e), e => (console.error(e, "service.interceptors.request.error"), e));
pe.interceptors.response.use(async e => ({...e.data}), e => (console.error("service.interceptors.response.error" + e), e));
const Un = {
    __name: "HomeView", setup(e) {
        ...
        function r() {
            const s = pe("/index/list");
            console.log(s, "res")
        }

        return (s, o) => (nt(), et("main", null, [o[0] || (o[0] = tt(" Home ")), me("button", {onClick: n}, "跳转"), me("button", {onClick: r}, "请求接口")]))
    }
};
